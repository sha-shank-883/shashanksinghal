    ...
    const openPopupboxReactWebsite = () => {
        const content = (
            ...
            <>
                ...
                <b className="link-desc">React-Website :  </b>  <a className="hyper-link" onClick={() => window.open(" https://sha-shank-883.github.io/react-app/")}>https://sha-shank-883.github.io/react-app/</a><br></br>
                <b className="link-desc">GitHub :  </b> <a className="hyper-link" onClick={() => window.open(" https://github.com/sha-shank-883/react-app/tree/master")} >https://github.com/sha-shank-883/react-app/tree/master</a><br></br>
    ...
    const openPopupboxWeatherApp = () => {
        const content = (
            ...
            <>
                ...
                {/* <b>Netlify:</b><a className = "hyper-link" onClick = {() => window.open("https://tenanttruths.netlify.app/")}>https://tenanttruths.netlify.app/</a> */}
                <b className="link-desc">Weather-App : </b> <a className="hyper-link" onClick={() => window.open("https://sha-shank-883.github.io/Weather-App/")}>https://sha-shank-883.github.io/Weather-App/</a><br></br>
                <b className="link-desc">GitHub : </b> <a className="hyper-link" onClick={() => window.open("https://github.com/sha-shank-883/Weather-App")}>https://github.com/sha-shank-883/Weather-App</a>
            </>
    ...
    const openPopupboxCapture15 = () => {
        const content = (
            ...
            <>
                ...
                {/* <b>Netlify:</b><a className = "hyper-link" onClick = {() => window.open("https://tenanttruths.netlify.app/")}>https://tenanttruths.netlify.app/</a> */}
                <b className="link-desc">Todo-App : </b> <a className="hyper-link" onClick={() => window.open("https://sha-shank-883.github.io/todo-app/")}>https://sha-shank-883.github.io/todo-app/</a><br></br>
                <b className="link-desc">GitHub : </b> <a className="hyper-link" onClick={() => window.open("https://github.com/sha-shank-883/todo-App")}>https://github.com/sha-shank-883/todo-app</a>
            </>
    ...
    const openPopupboxCapture14 = () => {
        const content = (
            ...
            <>
                ...
                {/* <b>Netlify:</b><a className = "hyper-link" onClick = {() => window.open("https://tenanttruths.netlify.app/")}>https://tenanttruths.netlify.app/</a> */}
                <b className="link-desc">Calculator : </b> <a className="hyper-link" onClick={() => window.open("https://sha-shank-883.github.io/Calculator/")}>https://sha-shank-883.github.io/Calculator/</a><br></br>
                <b className="link-desc">GitHub : </b> <a className="hyper-link" onClick={() => window.open("https://github.com/sha-shank-883/Calculator")}>https://github.com/sha-shank-883/Calculator</a>
            </>
