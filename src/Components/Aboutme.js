    ...
    return(
        <div id = "about" className= "container py-5">
            <div className = "row">
                ...
                <div className= "col-lg-6 col-xm-12">
                    <h1 data-aos="fade-up" className= "about-heading">About Me</h1>
                    <p data-aos="fade-up" className="aboutp">
                
I'm web designer & front-end developer with few month of experience.
I'm interested in all kinds of web development, but my major focus is on full stack developer.
I also have skills in other fields like branding, icon design or photo and video editing. As a web developer, 
